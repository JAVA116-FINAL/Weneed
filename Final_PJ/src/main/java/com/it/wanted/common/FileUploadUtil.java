...
public class FileUploadUtil {
   ...
   public static final int MEMBER_IMAGE_TYPE=5;//회원 이미지 등록
   ...
   public String getUploadPath(int type, HttpServletRequest request) {
      ...
      }else if(type==MEMBER_IMAGE_TYPE) {
         if(testGb.equals("test")) {
            upPath=fileUploadProps.getProperty("memberImg.upload.path.test");
         }else {
            upPath=fileUploadProps.getProperty("memberImg.upload.path");
         }
      }
