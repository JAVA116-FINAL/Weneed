		...
		<form id="form_2" class="proj-register-2" method="post" action="#">
			<div class="form-style">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<span class="projTitle">회사명</span> <input
								style="background-color: #ffffff; border: 1px solid #d9d9d9; border-radius: 5px; font-size: 1rem;"
								name="projComName" id="projComName" type="text"
								class="form-control projRegisterForm" placeholder="회사명">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group" style="margin-bottom: 0px">
							<span class="projTitle">담당자 성함</span><span class="register-star">*</span>
							<input
								style="background-color: #ffffff; border: 1px solid #d9d9d9; border-radius: 5px; font-size: 1rem;"
								name="projUserName" id="projUserName" type="text"
								class="form-control projRegisterForm" placeholder="담당자 성함">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<span class="projTitle">담당자 이메일</span><span class="register-star">*</span>
							<input
								style="background-color: #ffffff; border: 1px solid #d9d9d9; border-radius: 5px; font-size: 1rem;"
								name="projEmail" id="projEmail" type="text"
								class="form-control projRegisterForm"
								placeholder="연락 가능한 이메일을 기재">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group" style="margin-bottom: 0px">
							<span class="projTitle">담당자 연락처</span><span class="register-star">*</span>
							<input
								style="background-color: #ffffff; border: 1px solid #d9d9d9; border-radius: 5px; font-size: 1rem;"
								name="projHp" id="projHp" type="text"
								class="form-control projRegisterForm"
								placeholder="연락 가능한 번호를 입력">
						</div>
					</div>
				</div>
			</div>
			<div class="form-buttonArea">
				<button type="button" class="form-blueButton"
					onclick="location.href='${pageContext.request.contextPath}/freelancer/projectRegister/projectRegister2.do'">다음
					단계로</button>
			</div>
		</form>
	</div>
