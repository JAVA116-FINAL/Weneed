		...
		<br>
			...
			<!-- 프로그램 시작일 -->
		        <div class="proInfoDiv">
					...
					<input type="text" class="programTitleTextField" id="proStartDate" name="proStartDate" 
												value="<fmt:formatDate value="${proVo.proStartDate}" pattern="yyyy-MM-dd 00:00:00"/>">
		        </div>
			...
			<!-- 프로그램 신청 마감일 -->
		        <div class="proInfoDiv">
					...
					<input type="text" class="programTitleTextField" id="regiEndDate" name="regiEndDate" 
												value="<fmt:formatDate value="${proVo.regiEndDate }" pattern="yyyy-MM-dd 00:00:00"/>">
		        </div>
