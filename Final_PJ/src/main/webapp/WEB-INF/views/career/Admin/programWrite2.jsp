...
<div style = "width:980px; max-width: 100%; margin:auto;">
	<form name="proWrite2" action="projectDetail.do?proNo=" method="post">
		<fieldset>
		...
		<br>
			...
			<!-- 제목1 내용1 -->
				<div class="programBodyContents">
					...
					<textarea id = "description1" name = "description1" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목2 내용2 -->
				<div class="programBodyContents">
					...
					<textarea id = "description2" name = "description2" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목3 내용3 -->
				<div class="programBodyContents">
					...
					<textarea id = "description3" name = "description3" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목4 내용4 -->
				<div class="programBodyContents">
					...
					<textarea id = "description4" name = "description4" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목5 내용5 -->
				<div class="programBodyContents">
					...
					<textarea id = "description5" name = "description5" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목6 내용6 -->
				<div class="programBodyContents">
					...
					<textarea id = "description6" name = "description6" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
			...
			<!-- 제목7 내용7 -->
				<div class="programBodyContents">
					...
					<textarea id = "description7" name = "description7" rows = "5" cols = "80" placeholder = "상품설명을 입력하세요"></textarea> 
				</div>
