		...
		<div class="container" >
			  ...
			  <li class="nav-item active"><a class="nav-link" href="#title">Home</a></li>
			   <li class="nav-item"><a class="nav-link" href="#title1">Benefits</a></li>
				...
				<div style="width: 100%; font-size: 24px; text-align:center; color: black;float:left; margin-top:40px; margin-bottom:20px;">결제 완료 후 상단 메뉴 모음 'MY 원티드'에 들어가면, 바로 영상 시청이 가능합니다</div>
			</div>
			</div>
		</div>
		</nav>
