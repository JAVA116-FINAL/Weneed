	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="<%=request.getContextPath() %>/resources/images/about/img-1.jpg" alt="" class="img-fluid">
					<img src="<%=request.getContextPath() %>/resources/images/about/img-2.jpg" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="<%=request.getContextPath() %>/resources/images/about/img-3.jpg" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-12 testimonial-wrap-2">
				<div class="testimonial-block style-2  gray-bg">
					...
					<div class="testimonial-thumb">
						<img src="<%=request.getContextPath() %>/resources/images/team/test-thumb1.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="<%=request.getContextPath() %>/resources/images/team/test-thumb2.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="<%=request.getContextPath() %>/resources/images/team/test-thumb3.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="<%=request.getContextPath() %>/resources/images/team/test-thumb4.jpg" alt="" class="img-fluid">
					</div>
		...
		<div class="row clients-logo">
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/1.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/2.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/3.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/4.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/5.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="<%=request.getContextPath() %>/resources/images/about/6.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
		...
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					<div class="logo mb-4">
						<img src="<%=request.getContextPath() %>/resources/images/logo.png" alt="" class="img-fluid">
					</div>
