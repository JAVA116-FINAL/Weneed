...
<title>원티드 고객센터</title>
	...
	<link rel="canonical" href="https://help.wanted.co.kr/hc/ko">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="logo">
             ...
             <img src="//theme.zdassets.com/theme_assets/9309779/480a35976bf401a88dd7388d8f5c19d77227cd35.png" alt="원티드로고" id="heder_logo_image">
            </a>
            <!-- 고객센터 로고 -->
          ...
          <div class="container-menu">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle collapsed" data-target=".navbar-mind-collapse" onclick="location.href='/hc/ko/requests/new';">
                <img src="//theme.zdassets.com/theme_assets/9309779/e1f05b9e24e2a981e19c74b2536ade47ef1cde7d.png" id="request_btn_img">
              </button>
            </div>
            <div class="row">
                ...
                <ul id="drophover" class="nav navbar-nav primary-menu-list-wrap">
                  <li style="border:1px solid #f5f5f5;border-radius:30px;text-align: center;background-color:#3366FF">
                    <a href="<c:url value='/notice/notice_qna.do'/>" 
						...
						문의하기
                      <img src="//theme.zdassets.com/theme_assets/9309779/e1f05b9e24e2a981e19c74b2536ade47ef1cde7d.png" alt="requests_icon">
                    </a>
                  </li>
                </ul>
              </div>
